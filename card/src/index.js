...
const attributes = config.blocks['card'].attributes ?? {};
// eslint-disable-next-line
const supports = config.blocks['card'].supports ?? {};
// eslint-disable-next-line
const styles = config.blocks['card'].styles ?? [];
// eslint-disable-next-line
const features = config.blocks['card'].features ?? {};
